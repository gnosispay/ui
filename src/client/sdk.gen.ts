 ...
 * Create a Zendesk ticket to dispute a transaction. If the dispute reason is 'unrecognized_transaction_report_fraudulent', the user's card will be restricted.
 */
