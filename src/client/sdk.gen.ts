 ...
 * @deprecated
 */
export const postApiV1AccountBalancesKytIntercomTicket = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1AccountBalancesKytIntercomTicketData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, PostApiV1AccountBalancesKytIntercomTicketErrors, ThrowOnError>({
 ...
 */
export const getApiV1DisputeReasons = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1DisputeReasonsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiV1DisputeReasonsResponses, GetApiV1DisputeReasonsErrors, ThrowOnError>({
...
/**
 * Dispute a transaction by thread ID
 * Create a Zendesk ticket to dispute a transaction. The list of available dispute reason keys can be found in the GET /api/v1/dispute-reasons endpoint. If the dispute reason is 'unrecognized_transaction_report_fraudulent', the user's card will be restricted.
 */
...
/**
 * Use /api/v1/transactions/{threadId}/dispute instead
 * @deprecated
 */
export const postApiV1TransactionsDispute = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1TransactionsDisputeData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, PostApiV1TransactionsDisputeErrors, ThrowOnError>({
 ...
 * @deprecated
 */
export const postApiV1TransactionsReportFraudulent = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1TransactionsReportFraudulentData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, PostApiV1TransactionsReportFraudulentErrors, ThrowOnError>({
...
export const postApiV1UserReferrerCode = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1UserReferrerCodeData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiV1UserReferrerCodeResponses, PostApiV1UserReferrerCodeErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiV1UserReferrals = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1UserReferralsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiV1UserReferralsResponses, GetApiV1UserReferralsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
