...
/**
 * Create a new delayed transaction
 * Creates a new delayed transaction for the authenticated user.
 */
export const postApiV1DelayRelay = <ThrowOnError extends boolean = false>(options: Options<PostApiV1DelayRelayData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiV1DelayRelayResponses, PostApiV1DelayRelayErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * The request body structure is determined by the `options.setPin` boolean field.
...
export const postApiV1OrderByOrderIdCard = <ThrowOnError extends boolean = false>(options: Options<PostApiV1OrderByOrderIdCardData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiV1OrderByOrderIdCardResponses, PostApiV1OrderByOrderIdCardErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
