...
/**
 * Setup Monerium Integration
 * Creates a Monerium profile and links the user's address to enable IBAN functionality.
 * This endpoint creates the necessary Monerium profile, sets profile details, and associates
 * the user's blockchain address with their Monerium account.
 *
 * **Prerequisites:**
 * - User must have completed KYC verification
 * - User must have a Safe account setup
 * - User must have a verified EOA (Externally Owned Account)
 *
 * **Process:**
 * 1. Creates a Monerium profile using the user's email
 * 2. Sets up profile details from KYC data
 * 3. Associates the signer address with the Monerium profile
 * 4. Verifies address ownership using the provided signature
 *
 */
