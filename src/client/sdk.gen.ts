 ...
 * Create an Intercom ticket to dispute a transaction
 */
 ...
 * Create an Intercom ticket to report a fraudulent transaction using its thread ID, restrict the user's card, and create an internal note
 */
export const postApiV1TransactionsByThreadIdReport = <ThrowOnError extends boolean = false>(options: Options<PostApiV1TransactionsByThreadIdReportData, ThrowOnError>) => {
    return (options.client ?? client).post<PostApiV1TransactionsByThreadIdReportResponses, PostApiV1TransactionsByThreadIdReportErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
