 ...
 */
export const getApiV2Transactions = <ThrowOnError extends boolean = false>(options?: Options<GetApiV2TransactionsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiV2TransactionsResponses, GetApiV2TransactionsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
