 ...
 * Create a Zendesk ticket to dispute a transaction. The list of available dispute reason keys can be found in the GET /api/v1/transactions/dispute endpoint. If the dispute reason is 'unrecognized_transaction_report_fraudulent', the user's card will be restricted.
 */
