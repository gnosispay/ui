...
interface CreditCardBackProps extends React.SVGProps<SVGSVGElement> {
  name?: string | undefined; // Add undefined as a possible value

  // name: string | undefined | null;
  // className?: string | undefined;
  // Add any additional props specific to the Network component
}

const CreditCardBack: React.FC<CreditCardBackProps> = ({
  name = "SAXIFRAGE RUSSELL",
  ...props
}) => (
  <svg
