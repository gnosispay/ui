...
export default async function Home() {
  ...
  const token = safeTokenSymbol && SUPPORTED_TOKENS[safeTokenSymbol];
  const currency = safeTokenSymbol && SUPPORTED_CURRENCIES[TOKEN_TO_CURRENCY[safeTokenSymbol]];
  ...
  if (!token || !currency) {
    return <p>There was an error reading your account data.</p>;
  }
