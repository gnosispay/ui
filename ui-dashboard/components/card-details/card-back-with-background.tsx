...
const CardBackWithSVG = () => {
  return (
    <div className="flex-grow relative flex-col flex items-center gap-8 pt-10">
      ...
      >
        <CardBack
          cardInfo={{ cvv: "***", expiry: "**/**", pan: "4567************" }}
          cardholderName=""
          className="absolute top-0 left-0 w-full h-auto rounded-xl shadow-gp-card [transform:rotateY(180deg)] [backface-visibility:hidden]"
        />
      </div>
    </div>
  );
...
export default CardBackWithSVG;
